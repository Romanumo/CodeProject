...
namespace ChatGPTWrapper
{
	...
	{
		[SerializeField]
		private string _apiKey = ChatParameters.keyAPI;
		...
		[TextArea(4, 6)]
		[SerializeField]
		private string _initialPrompt = ChatParameters.prompt;
		...
		{
			_apiKey = ChatParameters.keyAPI;
			_initialPrompt = ChatParameters.prompt;
